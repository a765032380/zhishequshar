...
import com.bjxiyangshar.myapplication.MainActivity;
...
//                showPointForLogin();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (SPManager.getInstance().getString("mobilePhone",null)!=null){
            ...
            Intent intent = new Intent(SDLoginActivity.this, HomeActivty.class);
...
//                        +"&deviceId="+ 0+"";
                ...
                Log.i("appId",String.valueOf(APP_ID.APP_ID));
                APP_ID.APP_ID="2950B701-A720-4D4D-8CE4-C333ABF00E0F";
...
//       String regStr = "^([A-Z]|[a-z]|[0-9]|[`~!@#$%^&*()+=|{}':;',\\\\[\\\\].<>/?~！@#￥%……&*（）——+|{}【】‘；：”“'。，、？]){8,16}$";
    ...
    private void setSP(Users users){
        //会员编号
        SPManager.getInstance().putString("sharerId",String.valueOf(users.getResult().getSharerId()));
