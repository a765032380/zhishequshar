...
public class XYXuanZeXiaoQuAdapter extends BaseAdapter {
    ...
    private List<SelectXiaoQu.ResultBean> list;

    public XYXuanZeXiaoQuAdapter(Context mContext, List<SelectXiaoQu.ResultBean> list) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view==null){
            ...
            viewHolder.tv_item_xuanzexiaoqu.setText(list.get(position).getCommunityName());
        return view;
    }
